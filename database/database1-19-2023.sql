...
VALUES
  (
    ...
    '#000000',
    ' <a href=/sendfile/1673963558259.mp4 target=\"_blank\"  class=\"uplink\">/sendfile/1673963558259.mp4</a>',
    '/pic/1672779896506.jpg',
    'ㅤㅤㅤㅤㅤ',
    '#000000',
    'QzcnGP9DbXff4GDKAAK7'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    '#000000',
    ' <a href=/sendfile/1673980358449.jpg target=\"_blank\"  class=\"uplink\">/sendfile/1673980358449.jpg</a>',
    '/pic/1673471100349.jpg',
    'رجل شرقى',
    '#000000',
    'PGjRy302UIwbMhFIAALt'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    'cw822grzf5ilp938qwhm5b10uq8yleo',
    '#000000',
    '، انا ازيد الناقص ولا أنقص بدون احد  ف36',
    '/pic/1672779896506.jpg',
    'ㅤㅤㅤㅤㅤ',
    '#000000',
    '1iSMRPYA8knuhQgJAAOi'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    'cw822grzf5ilp938qwhm5b10uq8yleo',
    '#000000',
    'ثم يأتيك الله بما تمنيت يوماً  ف36',
    '/pic/1672779896506.jpg',
    'ㅤㅤㅤㅤㅤ',
    '#000000',
    '1iSMRPYA8knuhQgJAAOi'
...
VALUES
  (
    ...
    '#000000',
    '\n:أنتَتعلم أنك لن تصل لكن يبدو انه ليس لديك ماتفعله سوى المشي',
...
VALUES
  (
    ...
    'lsna0reajbrc2fvx2v8jhtsk6g2l84c',
    '#000000',
    '\n:و كأنني ساعي البريد ؛ لا شيء مما حملته كان لي .',
    '/pic/1674075961951.jpg',
    'جنات',
    '#000000',
    'hHalIRZjG-fSD7QuAAPz'
...
VALUES
  (
    125,
    '41.35.174.249',
    'والله عالم يمكن جان يكلهم اني باسل',
...
VALUES
  (
    134,
    '37.237.173.40',
    'لا اني جان بواقع ولا مواقع احجي بلوجة',
    'ㅤㅤㅤㅤㅤ',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    138,
    '41.35.174.249',
    'اني مشااكل شخص عنده مشاكل ويا غيري',
    'عًـــًـبــَــَد اًَلـًــــلـَـــَهَ',
    'شا'
  );
INSERT INTO
...
VALUES
  (
    139,
    '41.35.174.249',
    'انته جنت اي فلود فشار اي مشكلة',
    'عًـــًـبــَــَد اًَلـًــــلـَـــَهَ',
    'شا'
  );
INSERT INTO
...
VALUES
  (
    143,
    '37.237.173.40',
    'والنفسية تعبانة شوي من هل واقع الجايف',
    'ㅤㅤㅤㅤㅤ',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    148,
    '185.187.76.212',
    'بس اعرف بنية بالجات اكيد متخطبها\n',
    'دبسي',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    149,
    '185.187.76.212',
    'عود خايف عليه يعني وتقدر مشاعري فماردت اتعلق بيك مو\n',
    'دبسي',
    'شا'
  );
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (150, '185.240.18.99', 'جاوبي', 'mr.robot', 'جا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (
...
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (152, '37.237.240.30', 'دمك جامد', 'اودي', 'جا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (153, '37.237.173.18', 'لا موو جامد', 'ㅤㅤㅤㅤㅤ', 'جا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (154, '37.237.240.30', 'شكد حاطله وجاي', 'اودي', 'جا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (
...
VALUES
  (
    156,
    '151.236.169.145',
    'ايام زمان جانو حتى الاشخاص محترمين ',
    'ايام زمان',
    'جا'
  );
...
VALUES
  (
    1,
    '{\"siteScript\":\"1674077598827.undefined\",\"bg\":\"446282\",\"buttons\":\"446282\",\"background\":\"FFFFFF\",\"walllikes\":\"{\\\"likeMsgRoom\\\":\\\"0\\\",\\\"bclikes\\\":\\\"3\\\"}\",\"wallminutes\":\"1\",\"bclikes\":\"3\",\"msgst\":\"5\",\"pmlikes\":\"0\",\"miclikes\":\"300\",\"notlikes\":\"2\",\"fileslikes\":\"2\",\"allowg\":true,\"allowreg\":true}',
...
VALUES
  (
    ...
    '7nxu7ivg8v2rohmt22b5wgab8tyr5relnzk6h5byg39e8fjezb77s3xir78c4wz67rxmgxa8th9gpx8b7hwnbd8eusq4a9mc4vo73j2a6ty4exyj8tvt9c4drg19wlrufy37mturb764gk1kw2hrmwivbuw5lx9tnwfc03paldvgkixxh',
    0,
    0,
    1,
    '1674066970363',
...
VALUES
  (
    ...
    'zn1tnsqflkns80llho453yulo1qol77r3berggq2t3syteo0xta8b15xeaskqd7h5yu9w10t60f6wkl2ghwbo6blhxzisy5b4y6fi73eil2kpu3ru9jr6zgia4oayakxry12bxymx9slgdmeeo6l2q08hq9zxz3l8i1s1r809epdx8jjw',
    0,
    0,
    1,
    '1674079094467',
...
VALUES
  (
    ...
    'qhp1vj3ujtaixjumt46gpjooshe50phqn0a74bvtxkha8f0nrqlxhmpy364ckpxuqb6tey7r8e3qqsp877ts600yt6atpscad4nr6ebyxudthwgc5hf4ygsfpyypeyly7c6lgdm80o0flopf6vfxgvz7drb4ha2l5zmf6s4yaucbza6d2',
    0,
    0,
    0,
    '1674079542448',
...
VALUES
  (
    ...
    'ipq7h7pg1pr7n8cbko6pabefxp7ubd744lkq390w9e9zaetkts3vqbieuhpx4e6bmxz0zvqocy1u8fupg2q8n8s9xalwjhny0snzvhm35qnxtit15ecldb53nbiqqgpf7ugnp1e0rg9c3lmubv5ivrik9wso8yz3ez3tjk3b03sdrgt6f',
    0,
    0,
    0,
    '1674077495978',
...
VALUES
  (
    ...
    '1txo2sfy1aw2fqf1jysy97jpi8cqyie82zmvnin2r3ha1ah60k7wnzuhnybmtiyxj3grgua50tgo7ypx42zqoh2qdeiftz030awtgfslre1ytwk6kv1crhbs8vcsxze1hnxtlpwkdcrvvy49ip08lrv530l4cuseq5skakk45nkffrt9r',
    0,
    0,
    0,
    '1674071898313',
...
VALUES
  (
    ...
    '5jz4vmf5e91jln68sy829eteirh030k1yoapv171xlqpqscebpzdsmom5qhrwdgex9vj2tbxi22ldo6h19hqkn2msg88697utfeovmvh4q6nq9d1ol51np62w3v5f7k51in6zknyzq5l4hbcw3wcfcgazrdxvhdhlt1iyle105kyh9ra6',
    0,
    0,
    0,
    '1674050275098',
...
VALUES
  (
    ...
    'exbfi50156tubmhj6hexhu83vwhgfnwl0as6n48hd36y6pv3kwipsus1b905r4nuuilmclg13drhxn50monaim4ep7ii8jx0xw47k2dgtppq3lupogtskjnrolrsqbyih9k0nurxk5ir8rlnmqacmvdpl9anbd83gpcu5m5k89mywrsv9',
    0,
    0,
    0,
    '1674047093792',
...
VALUES
  (
    ...
    'p176zs3bsfpvcfxed6ppb9z1gx77ndee6frlsie2t5ijam64y1cd7nxizi4kybs994y2zpy8sldev2iwmwgfw57be8l0ccjob2aqaq0ik37lldotxhrneokers8vrjq912nws72j0su2077eu92mx4a2zavheqppuwramb5g029093nqr',
    0,
    0,
    1,
    '1674054599922',
...
VALUES
  (
    ...
    'asv0393pbjap3ks70nsa7yri75vsywmcrgrkoud7ypvxpfk1wpxejl8zj43kja1nkel03g2f2yclt2q5z3jel730xhci8oxgu2shujrn53rec6w412fgphauyuunk0wuspk52ih1u149hrh8dqdb8deijbu2hqe4p1kfpshr8k7wtsha6',
    0,
    0,
    0,
    '1674076225447',
...
VALUES
  (
    ...
    '99vhljmv1ftnl4j6rkutcakgkjewddzoc8b8wtpxy6ok5stzr565wicnt4um5z8yoaxqtnspvet0tdqvnh6cbr8nw1uk701szysvwj3acer9clwfxszefiwx6wp9zli9uhfd0114g2t4uwva1szhvvlgb72e1khyo8y5gh0mm2k0qj0z0',
    0,
    0,
    0,
    '1674071335177',
...
VALUES
  (
    ...
    'lij43j1hquvno7bn4qh85ckenh3balkcapgfqqfs6oq35zipkq24tkf315ycodcvyn0esmotragxpjiwspcru5665mxa8q1yzh4uswp08osst3ax40tq3xfdudjzqyyp5byqtx57lp6cmanxm4p1n2f9418e07jc5qzx86p2d82uq0b2v',
    0,
    0,
    0,
    '1674078881646',
...
VALUES
  (
    ...
    'wfooi88srxoetdw3whgcekc405ryzs088vovs3rdp8dz056cdhww2s5th9piirhvluqajx3k4d0ii9p6d04tnqz5ss3im1n24f99w4xirla5mwzft9adki75bjqump90ou8jjkc3qc53yexh024f66xug7lgomt2qjp2qn3mlvomw4mrp',
    0,
    0,
    0,
    '1674056866215',
...
VALUES
  (
    ...
    'dwbqqq1lqz8as1ejh3qcgddz5vzxpcy2tvldr2r949zz8ul775wghun0hsv62ygo1tabsf2rodxag46ggpo35n35df0t1ioffp0ihl25f8o5a0idfgzekjwlfg9ivj37pwubl884layxa5142z7crlnu2b33u4m56q4udvm9ucfqz9snl',
    0,
    0,
    0,
    '1674034695211',
...
VALUES
  (
    ...
    '1f88h9aqa11q5csp66ebaz1bxjfbm2izdie1g0voohhyb0q18vd59hqlcoy5khk59ul5clkhr18xm4yhme7s9xo4e3mj5amc1ywb7ilavotv6tqn6txh2xzu3924fc5j4rmisuyy6dlpr0i1a3tepidbi5pjtp33r4z5p9v9ov3zo5nte',
    0,
    0,
    0,
    '1674086172320',
