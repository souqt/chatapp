...
CREATE TABLE IF NOT EXISTS `stats` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 2144 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
VALUES
  (
    ...
    '،ِ زيٰـِـِنب آلٰـٖشمࢪٖي',
    '#000000',
    'KVswsuWoRraALUymAAlR'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    '#000000',
    ' <a href=/sendfile/1674591864666.jpg target=\"_blank\"  class=\"uplink\">/sendfile/1674591864666.jpg</a>',
    '/pic/1673470570131.jpg',
    ' ♡',
    '#FFFFFF',
    'RzGek71zX6VaI7OtAAle'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    '6c6ghwq05o838obnfcaqsk370okw8gb',
    '#000000',
    ' <a href=/sendfile/1674592099442.mp4 target=\"_blank\"  class=\"uplink\">/sendfile/1674592099442.mp4</a>',
    '/pic/1673470570131.jpg',
    ' ♡',
    '#FFFFFF',
    'WrKGXEef61skVgARAAlk'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    '#75373D',
    'يارب . .\n',
    '/pic/1674596979414.jpg',
    'ㅤㅤأوديـڪـار',
    '#000000',
    'f_J3UEqO0POHlP9PAAl6'
  );
INSERT INTO
  `bars` (
    `id`,
...
VALUES
  (
    ...
    '6c6ghwq05o838obnfcaqsk370okw8gb',
    '#000000',
    'بعض البشر لا يتغيرون أبدًا مهما فعلت، لذلك لا ترهق نفسك، ولا تُضِع وقتك معهم',
    '/pic/1673470570131.jpg',
    ' ♡',
    '#FFFFFF',
    '6cIGRD1w1e_7BQtYAAl-'
...
VALUES
  (
    ...
    'cw822grzf5ilp938qwhm5b10uq8yleo',
    '#000000',
    'لا يهمني صدرها ولا رقبتها ولكن اعشق فخذها   ف36',
    '/pic/1672779896506.jpg',
    'ㅤㅤㅤㅤㅤ',
    '#000000',
    'jg6xj5eWRIGRZHwNAAlr'
...
VALUES
  (
    ...
    'cw822grzf5ilp938qwhm5b10uq8yleo',
    '#000000',
    'ماذا تعشقون انتم في الدجاجة  ف36',
    '/pic/1672779896506.jpg',
    'ㅤㅤㅤㅤㅤ',
    '#000000',
    'jg6xj5eWRIGRZHwNAAlr'
...
VALUES
  (
    ...
    '6c6ghwq05o838obnfcaqsk370okw8gb',
    '#000000',
    ' <a href=/sendfile/1674597942327.mp4 target=\"_blank\"  class=\"uplink\">/sendfile/1674597942327.mp4</a>',
    '/pic/1673470570131.jpg',
    ' ♡',
    '#FFFFFF',
    '6cIGRD1w1e_7BQtYAAl-'
...
VALUES
  (
    ...
    '0xjkydxpeqiyma4pjl682xea69l9twu',
    '#75373D',
    ' <a href=/sendfile/1674598104606.jpg target=\"_blank\"  class=\"uplink\">/sendfile/1674598104606.jpg</a>',
    '/pic/1674596979414.jpg',
    'ㅤㅤأوديـڪـار',
    '#000000',
    'f_J3UEqO0POHlP9PAAl6'
...
VALUES
  (
    292,
    '37.77.77.8',
    'شكد هيلك تره دخلت اشوف الشات ولا اعرفكم ولا شيء ؟',
    'ً',
    'شات'
  );
INSERT INTO
...
VALUES
  (
    297,
    '156.208.249.115',
    'هذا ابو مطيته مجالَ كوليله لا ما مطيتهَ ههههه عن اذنج لان عندي شغل يا وردَة\n',
    '     -',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    298,
    '37.238.225.18',
    'ولد دز تنبيه كلي كلج مطيته مجال\n',
    '،ِ زيٰـــِنب آلٰـٖشمࢪٖي',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    301,
    '37.238.225.18',
    'اهلا بيك هههه شات فارغ بس رجع لمهم',
    '،ِ زيٰٰـِنب آلٰـٖشمࢪٖي',
    'شات'
  );
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (
    302,
    '37.238.225.18',
    'ههه هلابيك شات فارغ بس رجع لمهم',
    '،ِ زيٰٰـِنب آلٰـٖشمࢪٖي',
    'شات'
  );
INSERT INTO
...
VALUES
  (
    304,
    '212.15.84.116',
    'جاي اتخيل شلون يصير عدج جهال ع هالفطاره ف3',
    '،',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    305,
    '212.15.84.116',
    'الكعده هاي يرادلها قوري جاي.  ف170',
    '،',
    'جا'
  );
INSERT INTO
...
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (307, '212.15.84.116', 'جيبي شاحنخ', '،', 'شا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (
...
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (309, '212.15.84.116', 'ليش جاهل اني شنو', '،', 'جا');
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (
...
VALUES
  (
    311,
    '37.238.225.18',
    'موصوف يكتلني حتا نته جاي عليه حطك وكتلك ف61',
    ' ㅤ،ِ زيٰٰــِنٖب آݪٖـشِـمࢪٖي ',
    'جا'
  );
INSERT INTO
...
VALUES
  (
    313,
    '212.15.84.116',
    'غير اني من دخلتي للشات دخلتي گلبي وه\n',
    '،',
    'شات'
  );
INSERT INTO
...
INSERT INTO
  `histletter` (`id`, `ip`, `msg`, `topic`, `v`)
VALUES
  (316, '212.15.81.219', 'واني جاوبتك ', ' ♡', 'جا');
...
VALUES
  (
    ...
    '45.128.120.112',
    'IQ',
    'Android.9.z57.jno.xjs.Chrome.pq8.hqh.36z',
    'www.google.com',
    '1674570025948'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.238.40.28',
    'IQ',
    'Android.9.ppg.z16.h4c.Chrome.h1v.vcq.12e',
    'www.google.com',
    '1674570879546'
  );
INSERT INTO
...
VALUES
  (
    ...
    '169.224.9.171',
    'IQ',
    'iOS.16.2.bjh.b13.dk5.Mobile Safari.iqp.y6v.108',
    'www.google.com',
    '1674525807136'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.236.186.20',
    'IQ',
    'Android.11.wzn.565.t4z.Opera.55y.qca.q0f',
    '*',
    '1674530485476'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.239.86.38',
    'IQ',
    'Mac OS.10.15.7.q4p.n5c.nm5.Safari.9ht.chc.6ve',
    'www.google.com',
    '1674535606472'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.239.18.48',
    'IQ',
    'Android.6.0.1.axe.f2m.91m.Chrome.ohe.e2k.kou',
    'www.google.com',
    '1674555102154'
  );
INSERT INTO
...
VALUES
  (
    ...
    '91.106.42.137',
    'IQ',
    'Android.11.hyy.zc5.fwy.Chrome.obv.lpq.1w7',
    'www.google.com',
    '1674556595185'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.245.69.84',
    'AE',
    'Windows.10.w9z.io4.w4y.Chrome.cqr.7sv.y6f',
    'www.google.com',
    '1674556980601'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.238.243.13',
    'IQ',
    'Android.12.prl.tcd.42x.Chrome.fmt.9gk.qbv',
    'www.google.com',
    '1674564258690'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.174.21.222',
    'FR',
    'Android.10.8k8.tht.qcu.Chrome.v8s.q2t.i28',
    '*',
    '1674571282681'
  );
INSERT INTO
...
VALUES
  (
    ...
    '185.104.159.46',
    'IQ',
    'iOS.12.5.6.rt3.xr0.a3g.Mobile Safari.jkt.46f.d30',
    'www.google.com',
    '1674573042181'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.77.68.85',
    'IQ',
    'Android.11.big.i7y.22q.Chrome.3lz.unc.9nw',
    'www.google.com',
    '1674582096384'
  );
INSERT INTO
...
VALUES
  (
    ...
    '65.20.131.147',
    'IQ',
    'Android.13.57o.4jl.1lz.Samsung Browser.66q.du4.bp1',
    '*',
    '1674583758339'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.238.225.18',
    'IQ',
    'Android.8.1.0.by8.kr3.h8b.Chrome.4sa.hte.931',
    'www.google.com',
    '1674590268975'
  );
INSERT INTO
...
VALUES
  (
    ...
    '37.77.77.8',
    'IQ',
    'iOS.16.1.2.mzg.s9z.3jl.Mobile Safari.l41.q94.o2m',
    'www.google.com',
    '1674585981192'
  );
INSERT INTO
...
VALUES
  (
    ...
    '212.15.81.219',
    'IQ',
    'Android.11.agk.fnp.5mr.Chrome.di3.6s9.75b',
    'www.google.com',
    '1674603016601'
  );
INSERT INTO
...
VALUES
  (
    ...
    '212.15.84.199',
    'IQ',
    'Android.11.h9v.4uk.0iq.Chrome.65z.c1m.75b',
    'www.google.com',
    '1674590856133'
  );
INSERT INTO
...
VALUES
  (
    ...
    '151.236.166.238',
    'IQ',
    'Android.11.rvu.ilg.9k3.Chrome.ek2.8h3.s1k',
    '*',
    '1674608849614'
  );
INSERT INTO
...
VALUES
  (
    699,
    '121',
    'Android.9.3e4.ue8.lo7.Chrome.jlu.nzg.b5s',
    '37.238.40.28',
    'نوس',
    'نوس'
  );
...
VALUES
  (
    ...
    '[\"1673470339035.gif\",\"1673470343623.gif\",\"1673712883459.gif\",\"1673712907809.gif\",\"1673712923329.gif\",\"1673712964290.gif\",\"1673712967709.gif\",\"1673712973568.gif\",\"1673712977545.gif\",\"1673727208047.gif\",\"1673727271663.gif\",\"1673808138462.gif\",\"1673808144439.gif\",\"1673809627095.gif\",\"1674587078434.gif\"]'
  );
...
VALUES
  (
    ...
    'fo37du3vfhbwghz1zhe2335m2exigiwyog6f6taqvtaesq2yigs90r55v2wi29rwqt5cv397xy202gs533sv4a5cnyhuhxuyjp0sjhdox4tlnn7lg4p6r544pbt1hfd1pfnmty2vizlzf8c1q1d55sjowobrdkp1z0d0ontxdmid6355w',
    0,
    0,
    1,
    '1674595460466',
...
VALUES
  (
    ...
    '8fi06opv47z0wi3u6mztxy2a5t50w67b6ag51gi963bsugqyk3xtw6f4pjc7t308dcx4o2yxn3eov623k83uticpooltlpqoepmjtq04xglkc0n7qsiy28obax8o5yrykit72vx6z8nrh85xy4f7xw0ynejb72c429fyagfg52kpkdu6y',
    0,
    0,
    1,
    '1674522875173',
...
VALUES
  (
    ...
    'kdyo9mdl6ad6ppm2skawosbakdr7o42ep3n12thzurxcanbh72kdkerkird8ojhc7apnjz21y579xaj0684ev66ad60vsd5vk8q0wrez96wcegj1nr8ghaxjlqhu4ia4r5723dclmj026htnjk3sgax192tflla1wytch0wnwjjf4e70q',
    0,
    0,
    0,
    '1674580641866',
...
VALUES
  (
    ...
    'fd623pkzdf3vd1vevv2xl5sdzvy0wm5ucfnns6fhdt58rgu6yqxu1ag6zy46mglhaull7owct7zjjjva0zh6ntjzj8czyzs4wsto2qvhlvjr55d6duivp1a48krqo005lca773hr99trsc9lpbd5xr32vh2l6y9pk2cr3fjbdx85kr18k',
    0,
    0,
    0,
    '1674607589646',
...
VALUES
  (
    ...
    'g17hh9k1i3fooh457texykyhz48xufoa6ras6q7lqra51m27o50k7xhd8wndwtfm7luwk5se07s64nhntqvgld0gznmjacicmo4chaf9kcuepgw779tl1leilcndl4g379iixijmm77gjc3ipogt0kmypc7w0n91chgfbervld3kb19zb',
    0,
    0,
    0,
    '1674602492240',
...
VALUES
  (
    ...
    'v334yns4equgscu857appw4a4wz1wqn73gdml5ord5p6mhq2ptm0y6ms11kugw1l9psxs4hsx5dx1ptjlwt1ii4jp085grjx10d217hgyn5rewvhqd1j40szaa2wcdqw955iw9h2tktenvyv6u0xk1hureskrr62fhwcx8uxowemlkorh',
    0,
    0,
    0,
    '1674557503403',
...
VALUES
  (
    ...
    '156.208.249.115',
    'Windows.10.p3o.f8b.agz.Chrome.udq.sz0.xo2',
    'Jsu3PTyuU8XYBzapAAk_',
    'rhj6ss83c402eop8nof5vi1ns608buh',
    'lifo2cu0163ylotz7wfu3l',
    'مشغوول لحد يراسلنيَ',
    '/pic/1674586874231.jpg',
    'عبوش',
    1501,
    '     -',
    'عبوش',
    'sha1$9c255fbd$1$1ea8fb79bab3a2749420b89ab08fa902f3060e30',
    '2h6n24ak3tzj264rpjfc5hq5h5zdqpc1zdobanaxqaxfj0xkecsxbxa88ykdpugk5wm0c2zr2ankv2vje5qiivfphz4zthg697l29noryvjjcuo9fwuecazdjoapnkj78boe1ajjvvk9yqljr0573hqapl63jhawl0imq1b2ud0210eo4',
    0,
    0,
    0,
    '1674589787724',
...
VALUES
  (
    ...
    '/pic/1674592769777.jpg',
    '',
    2502,
    '     ㅤㅤﺻَﺻۧۂــَٰـِڪَــۧۥـِٰٖرࢪ.῞̮♯  ',
    'نسيان',
    'sha1$a7ef1034$1$9a4d744c2ecfa8f58aa8ad7e1d3f62b33d4c23c5',
    'k7vi0zloajeqcyy4vov0jyhqq2g78s4f53hddr9w3v03v1n6esiaaavq55pxflbszfugb3lo31oqd19w0rijdsa2x8t11e79ex7i2rdw3zbfms1nw24y042k0jqawf5054v2762fq7ii99cwsi11cgwyngz6r8q8nsmmnimp371fw6xmu',
    0,
    0,
    0,
    '1674594196834',
...
VALUES
  (
    ...
    'g6s4di61mfhlyfxw6mc17lq7hubbvh9hg389uvqi39q1xyg1kk7llaeys7rcsv66ffl2jlp7e3w5z54iafqmv6m5qmyduaikt3l6i25dwxch9jjm61bs67k7kecuuwl9ctfiqlrr29shftxxrc6ejyy0zbmm9mnuo37hr129fllq13gwf',
    0,
    0,
    0,
    '1674603993504',
...
VALUES
  (
    ...
    '37.239.166.7',
    'Android.11.zgq.zbw.wa6.Chrome.8gf.m2s.oq0',
    'yMYPkEBPBGQ0w5C0AAl9',
    'jqhnia8lg0859yrcqcky6ywi8w9iz62',
    'zc929ohc5pc7x1hfg90tyn',
    'الناكر المعروف والعشرة ذيچة كلوله من يعود شرط اله?؛؛؛',
    ...
    'uxikwfzocg0v9ve6oa60dk1gmqj3jo8fdvykrhss46ns93swg3l0v5wj6b5ailu9m71strlx1xcta8wz5zz4w2nqtu4z6chfief875vud9xepw8ectytmu0sa97d62lh2qayn6g7x7oyzyluec87ht50r29twbooght2ks7mvroqkb4qk',
    0,
    0,
    0,
    '1674597310854',
...
VALUES
  (
    ...
    'cka1ll9tnye3vd78e85tsx5zrr2cf2ww7r3drbhribzcrbj3v818zkehtrzjb7ay9k5rd1y6jrdzyc1uv5fo5wnf3yz6a77s6b2w7gfi3przxgo7x8fk13x2cj7p5jxh4epq6kjrv33dcknm47o0q6b0slg75ar7beds7vjg88ffy3ahx',
    0,
    0,
    0,
    '1674602749469',
...
VALUES
  (
    ...
    't81al36bmln7bedv6lnw6i8p2licl2g8gqzakkbt4zm51zpg29ucdyufr2ujgu7jmi2kk5clez0cioidnigbjq6pozlt2sjrsf3n315k0unj9jtotdcju1yqus2o2zcpzgsr2un7d6cooifh4otuomlwzkqb11zomowcqwb0hdr90sos2',
    0,
    0,
    0,
    '1674600559007',
...
VALUES
  (
    ...
    'v83tfcjn18fecypimcjdbwwnn62e560qx56beqw2cso3ox95nbt7er00bukzfx2fawfxwi3y126pyuzqgd6owbrm64xz4iuszw67uc6i17gg1kgevybo2g4dtjtthcwwomf7mlx4vitg1ajwt26y72hab3t25q255xki8q2xd08mwoazr',
    0,
    0,
    0,
    '1674535804391',
...
VALUES
  (
    ...
    'ogczotv84f27biv9xbotzfhw0ifrpybc83qb6dl41d2mo330pkvhsqj6s8ktvdtrm3p3ol92hgweahchmj3nm9fihgvg3kggvsezq2fxpg4plqunbjim4pcy7ncn0jc1fwtile1uft0bfbrgej897n6ggernssyamzomjllx8gm07khxu',
    0,
    0,
    0,
    '1674599372732',
...
VALUES
  (
    ...
    '#000000',
    29,
    '/dro3/1673700799514.gif',
    '37.237.240.27',
    'Android.11.cci.151.2nx.Chrome WebView.lz5.bjo.5aw',
    'XnX5UUjK5ulyEQSLAAmM',
    '0xjkydxpeqiyma4pjl682xea69l9twu',
    ...
    'gotjkobvkhpf8km8odsk1k7q65l7z1oakxac8d1cu8nbn7xr5n1bvn1vcix2i5na84oczd48mopilvb79ow6dy87l8f0aeyvg9qrsha6d1nphv294esb49xi77lij93ir3i4nt9jylzhkgugpsttmz3pntsrxmh33s75x213183rcp2jq',
    0,
    0,
    0,
    '1674599395485',
...
VALUES
  (
    ...
    '7p2xy7bjb881dimp9ecz06v9m6rwrx9bi02e28v0gnmstobb0wmdc6ebz6acl13xa9e8aqkrkmtzas6zlv27ednydtixnln99ys3ga96ycsing2f5bule3ci937o084vu52zcpgnlgabqqgh0qpi8dk55zlh3lv8tpqnpmmchqgdp4z1c',
    0,
    0,
    0,
    '1674570033075',
...
VALUES
  (
    ...
    'uqb2h0pgmw2giju2mfitt24u2c0ktonr388cgi4gyga1udx5xlj33qubd9od19s746ves8imcy2dq4zhw4wutg9k9zcyacakd3i4sl0mwceeqrxotk1euvcfvs35jtpi2v0gc3831smqsxp5f9e1gc6sy85mjiqensrvht08q9d89peow',
    0,
    0,
    0,
    '1674594626520',
...
VALUES
  (
    ...
    'dehlrcofilgmqxw8ay1aame14077w6ri7nl6b2m5krmvfema2woo5ku0s2xw8mx7v5k2hdy5yrunci0mv8exn9rc9hx9hqpn7sot81jew5zwudiadacxvmub5vin04q2rrf1ucg3gl36zqwe0pyfi20nft020aycv90j5ljustuxs8256',
    0,
    0,
    0,
    '1674571000337',
...
VALUES
  (
    ...
    '185.54.158.50',
    'Android.11.6qu.4la.9r3.Chrome.5kg.o4r.sim',
    'otLM79l8BSmVcCfxAAl5',
    'cqx2r96vnd89ae3p5d6ucdfj4a603c4',
    'hgoo8lozh3hpadd9shj4v6',
    '(عضو جديد)',
    '/pic/1674596421578.jpg',
    '',
    10000,
    'آَزࢪُ',
    '١٢٣',
    'sha1$4afc170b$1$9b3c82c597c30815f4aa82d2227de1ccbc821343',
    'n4xn70y1kw6ezwn7svgzk29lbumyijn5ijfbtkpd6c4vdlaz7onx9r8jnzn10pw5tdbd914r8ur69syd81gepk12jry0wx9zgdzn5rg8t71n9w5f34kqgmlepio01b2u5w8cjg96lnh3ftq8wm1q4asohfrs28wbrgbrnfvl8dtbydix2',
    0,
    0,
    0,
    '1674597001299',
...
VALUES
  (
    ...
    ' ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤآلنظـرِٓ اليكمٰ مقـࢪفٰ؟ ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ',
    '/pic/1674501789372.jpg',
    'زينب الشمري',
    100000000000,
    ' ㅤ،ِ زيٰٰــِنٖب آݪٖـشِـمࢪٖي ',
    ...
    'anobf86keyni7467c8twfof7i2x7bojsz7m6iqvdxof9zftiew0btm7nf277gwxowjyeavd61phv9enx7oonk2m6b982dr6urxstcw86ytdkp58h6iqab1g23kytjm1ctotadjn2xiv32m81fkyo17zfrv0qinvrxm7gszewwbqk4r52a',
    0,
    0,
    0,
    '1674597363598',
...
VALUES
  (
    ...
    '37.236.186.20',
    'Android.11.wzn.565.t4z.Opera.55y.qca.q0f',
    '4c79xYtkNKhDbCRYAAjX',
    'dy4zh1891jb6zuao0jzl9xwxp6ua8f0',
    'nebo1zceonlp2e8xhmio87',
    '(عضو جديد)',
    'pic.png',
    '',
    1,
    'ميم',
    'ميم',
    'sha1$755fd09e$1$b7cbc5dfb2a4aca953dfed72b4b55baff1f738f7',
    '7zhaxwfss3qxr8f2wqs9kz5110dz6w8u59nrwtjwkeg6b3oso85liigl5n0hxv884ilg4lbp4p6x04istpzdjr269mxjy1utqvoqx97qr70qrj3l15f30sxj6gyxocl2r4cmc7rsy2yl5bx6tw10w5e10y4psukor02ivvfgnb62aodl0',
    0,
    0,
    0,
    '1674530853274',
...
VALUES
  (
    ...
    '91.106.42.137',
    'Android.11.hyy.zc5.fwy.Chrome.obv.lpq.1w7',
    'q1oxEzRwDRwnSlM3AAjz',
    'payxywy7oofvxb6r0r77mciw4ugucx0',
    'tw6ec6xweby0h8tgwwdjb3',
    '(عضو جديد)',
    'pic.png',
    '',
    0,
    'سارة',
    'سارة',
    'sha1$dc045656$1$b7d2fb47d47d4c186f0169df8e1cc4a2f54e8404',
    'b41hczm3lncxknuzdawundojl457cqm6mh1p372rkoeyys81mq8eugml8m9c3fqeawiuai759urd114vlq7y4fh3p6bvxhnixbcsltfyxk1aiyokxtcx82esmb79ll82jfbgg9i5jd97qbbrrcseydyllnup4nijvr34ag36huhtf870y',
    0,
    0,
    0,
    '1674556661564',
...
VALUES
  (
    ...
    '65.20.131.147',
    'Android.13.57o.4jl.1lz.Samsung Browser.66q.du4.bp1',
    'QlnV_uF_p_jF-xb_AAky',
    '9zjtgqqylm0vgd0ae73sf9a7ufgemzc',
    'yz2tug2mu31bi8l86h45nb',
    '(عضو جديد)',
    'pic.png',
    '',
    0,
    'ميار ميار',
    'ميار ميار',
    'sha1$cbaafa4d$1$b27cb7c2f5def90534d2c0ce84ae3c955430c108',
    'azwlszgjmfdr5cuoajm298a511aead6yfgarx8dujv1adcu4qzhnte7kude67x9ve0g5c0icd3er8cw7v489dmkn62omc4owp5vobukjk3fhxw6vqn8ootf64pf873tkfhtv8he3yfjud3532zwjo6l7gwknfg0a293lh04fo5f537src',
    0,
    0,
    0,
    '1674583804744',
...
VALUES
  (
    ...
    '212.15.84.116',
    'Android.11.h9v.4uk.0iq.Chrome.65z.c1m.75b',
    'SWJd_HBOeCYFEAEEAAli',
    'e5ljir5mdavbulkszbdctjdqxo9py9a',
    'tyksl29k27yark3fwr6eor',
    'عِش نقياً فداك القيل ، والقال. ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ',
    '/pic/1674596417191.jpg',
    '',
    10000008,
    '،',
    'Mr',
    'sha1$48ea45af$1$633f6e0c66537f78742e19e58150cd6853ffe8ce',
    'no2wc5k5cpoc3065h4teg7vbthw131kprzhc4x23t9e5b332njilbclwkl2hpccxwxn1n0r8iivnrit2s33mimf1c1r07uutq8hhwej4u5jljw10a0p5pcrvj7idtsd6hwxnyivjowzd3b7raj4r200l6n1oz8e5zs42wkfcv2lpf16jl',
    0,
    0,
    0,
    '1674597383301',
...
VALUES
  (
    ...
    '151.236.166.238',
    'Android.11.rvu.ilg.9k3.Chrome.ek2.8h3.s1k',
    'Ya4_BDSX78vFk2fSAAmr',
    'd6bpa7gg6sxrrgw72zgxu6ogjkc841y',
    'sg78tvlo2xx1wge1hg08bi',
    'وان اتاك الزمان بـ مثلي لك ماتشاء',
    '/pic/1674608920453.jpg',
    '',
    0,
    ' بـَِـ.ًٌ‘⁄ﮧـراوي ا‘ࢦـَِدࢦـيـ.ًٌ‘⁄ﮧـمـي',
    'قانون',
    'sha1$053ed534$1$a9d71b2de5ff3b30131dfdff1f71f09f940cd79e',
    'rxk420z44esywumirz4cgtyysuryj87uo3c7pdrmmy06bbagp14s495jiebsof7pm24ntytnrsnd11yn2qodubp23530bugsuhrgn3pqjfk0e6eoexbbntipe3vi9fybt4nw1b7q227hco1oz6k18fl56vs4rp73ewke4fumatl42shok',
    0,
    0,
    0,
    '1674609138956',
